   ...
   return(
          ...
          <div className="space-y-6">
            ...
            <div className="flex items-start gap-4">
              <span className="text-2xl">
                <Image src="/vector-1.png" alt="Error" width={20} height={20}></Image>
              </span>
              <div>
            ...
            <div className="flex items-start gap-4">
              <span className="text-2xl">
                <Image src="/vector-2.png" alt="Error" width={20} height={20}></Image>
              </span>
              <div>
            ...
            <div className="flex items-start gap-4">
              <span className="text-2xl">
                <Image src="/vector-3.png" alt="Error" width={20} height={20}></Image>
              </span>
              <div>
      ...
      <div className="mt-12 h-[250px] items-center flex justify-around bg-gray-100 py-6 shadow-md">
        <div className="text-left gap-3 flex">
          ...
          <Image src="/trophy-1.png" alt="Error" width={60} height={60}></Image>
          </span>
        ...
        <div className="text-left gap-3 flex">
          <span className="text-2xl text-gray-600">
          <Image src="/guarantee.png" alt="Error" width={60} height={60}></Image>
          </span>
          <div className="flex flex-col">
        ...
        <div className="text-left gap-3 flex">
          <span className="text-2xl text-gray-600">
          <Image src="/customer-support.png" alt="Error" width={60} height={60}></Image>
          </span>
            <div className="flex flex-col">
